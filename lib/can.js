...
module.exports.Can = { none : "none", cola:  "cola", fanta : "fanta", sprite : "sprite", beer : "beer"};
module.exports.Choice = { cola : "cola", none : "none", fanta : "fanta", sprite : "sprite"};

module.exports.ContainerManager = function() {
  var cns = {};
...
module.exports.CanContainer = function() {
  var that = this;
...
module.exports.Chipknip = function(initial_value) {
